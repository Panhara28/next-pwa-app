    ...
    <article className="grid-article-top-first article-top-big">
      <div className="article-top-big-wrapper">
        <Link href={`/article/${articleTop[0].id}`}>
          <a>
            <Image priority={true} src={parsedImage(articleTop[0].thumbnail, 800, 420)} alt={articleTop[0].thumbnail} width={800} height={420} quality={100}/>
          </a>
        </Link>
        ...
        <div className="article-top-big-absolute">
          ...
          <div className="article-top-big-detail">
            ...
            <Image priority={true} src={getArticleContentWriterProfilePiceture(articleTop[0], 128, 128)} alt={articleTop[0].contentWriter.name.en} width={25} height={25} quality={100}/>
    ...
    return(
      <article key={inx} className={`grid-article-top-${articleOrder[inx]} article-top-card`}>
        <Link href={`/article/${article.id}`}>
          <a>
            <Image priority={true} src={parsedImage(article.thumbnail, 400, 210)} alt={article.thumbnail} width={400} height={210} quality={100}/>
          </a>
        </Link>
        ...
        <div className="article-top-card-detail">
          ...
          <div className="article-top-card-detail-small">
            ...
            <Image priority={true} src={getArticleContentWriterProfilePiceture(article, 128, 128)} alt={article.contentWriter.name.en} width={25} height={25} quality={100}/>
