      ...
      <ArticleLayout>
        ...
        <ArticleLayoutDetail>
          ...
          <div className="grid-article-thumbnail">
            ...
            {
              article.audio ? 
                <div className="article-thumbnail-audio-badge">
          ...
          <div className="grid-article-summary">
            ...
            <span className="article-summary-datetime"><i className="fal fa-calendar-days"></i>&nbsp;{getDateByFormat(article.publishedDateTime.en, "DD-MMM-YYYY")}</span>
