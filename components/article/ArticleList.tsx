      ...
      <article className="article-list-item" key={article.id}>
        <Link href={`/article/${article.id}`}>
          <a className="article-list-item-thumbnail">
            <Image unoptimized={true} src={parsedImage(article.thumbnail, 250, 130)} alt={article.thumbnail} width={250} height={130}/>
          </a>
        </Link>
        ...
        <div className="article-list-item-detail">
          ...
          <div className="article-list-item-detail-author">
            ...
            <Image unoptimized={true} src={getArticleContentWriterProfilePiceture(article, 128, 128)} alt={article.contentWriter.name.en} width={25} height={25}/>
            ...
            <div className="article-list-item-detail-author-datetime"><i className="fal fa-calendar-days"></i>&nbsp;{getDateByFormat(article.publishedDateTime.en, "DD-MMM-YYYY")}&nbsp;</div>
        ...
        {
          article.audio ? 
            <div className="article-list-item-audio-badge">
